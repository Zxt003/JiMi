 ...
 <style>
     ...
     .overlay {
         background: var(--lightblue) url("images/20.jpg") no-repeat fixed center;
         background-size: cover;
         height: 100%;
         left: -100%;
         position: relative;
 ...
 <div class="container right-panel-active">
     <div class="container__form container--signin">
         <form  action="LoginServlet" method="post" class="form" id="form1">
             ...
             <input type="password" name="userPwd" placeholder="Password" class="input">
             <button  class="btn" >Sign In</button>
         </form>
     </div>
     <div class="container__form container--signup">
         <form action="RegisterServlet" method="post" class="form" id="form2">
             ...
             <input type="password" placeholder="Password" class="input" name="userRePwd" />
             <button class="btn" id="zhuce">Sign Up</button>
         </form>
     </div>
